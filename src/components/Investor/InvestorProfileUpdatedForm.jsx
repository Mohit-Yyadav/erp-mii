...
import styles from "../../assets/css/investor/InvestorProfileUpdatedForm.module.css";
import { useForm } from "react-hook-form";
import axios from "../../../utils/Axios";
import { toast } from "react-toastify";

function InvestorProfileUpdatedForm() {
  ...
  return (
    <div className={styles.investorBody}>
      <div className={styles.investorContainer}>
        ...
        <form action="" onSubmit={handleSubmit((data) => submitData(data))}>
...
export default InvestorProfileUpdatedForm;
